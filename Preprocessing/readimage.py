...
import glob
path = './dataset/'
paths = glob.glob(path+'IXI/*')
image = 'ADNI1_109517.nii'
image_name = 'ADNI1_109517.nii.gz'
pathc = '/home/lab/braintransformer/dataset/ADNI1/'+image
...
pathp = []
#path_label = path + 'label/OASIS.csv'
#for i in range(len(paths)):
#    pathp.append(paths[i][16:])
j = 1
num = 1
...
for i in range(num):
    ...
    plt.imshow(alldata[0][100,:,:], norm='linear')
    plt.subplot(2,num,i + 2)
    plt.imshow(alldata[4][:,:,91])
