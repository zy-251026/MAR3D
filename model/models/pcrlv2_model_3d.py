...
class OutputTransition(nn.Module):
    def __init__(self, inChans, n_labels):
        ...
        self.final_conv = nn.Conv3d(inChans, n_labels, kernel_size=16, stride=16)
...
class PCRLv23d(nn.Module):
    ...
    def __init__(self, n_class=1, act='relu', norm='bn', in_channels=1, low_dim=128, student=False):
        ...
        self.conv1 = nn.Conv3d(1,1,kernel_size=7,stride=(2, 2, 2),bias=False)
